...
public class BulletControlSystem implements IEntityProcessingService, BulletSPI {
    ...
    public Entity createBullet(Entity shooter, GameData gameData) {
        ...
        // lidt mindre polygon, men samme form
        ...
        // spawn 12 i stedet for 10 enheder fra skudhullet
        ...
        bullet.setRadius(2); // en smule større radius
        return bullet;
    }
    ...
    public void process(GameData gameData, World world) {
        for (Entity proj : world.getEntities(Bullet.class)) {
            // Brug frame‐uafhængig hastighed (samme logik som lærerens, bare med nye navne)
            ...
            // (Valgfrit) du kan fjerne bullets, hvis de forlader skærmen:
            // if (proj.getX() < 0 || proj.getX() > gameData.getDisplayWidth()
            //  || proj.getY() < 0 || proj.getY() > gameData.getDisplayHeight()) {
